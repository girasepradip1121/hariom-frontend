...
export default function NewArrivals() {
  ...
  useEffect(() => {
    const fetchNewArrivals = async () => {
      try {
        setLoading(true);
        const response = await fetch(`${USER_BASE_URL}/api/products/new-arrivals`);
        if (!response.ok) {
  ...
  return (
    <section className="py-8 lg:py-12 container mx-auto px-2 md:px-4 lg:px-10 xl:px-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-6">
        {products.length === 0 ? (
          <p className="text-lg text-gray-500 col-span-full">No new arrivals available.</p>
        ) : (
            ...
            >
              ...
              <div className="py-4 px-3">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <p className="text-[#393185] text-sm font-semibold">

...
const AboutUsPage = () => {
  return (
    <>
      <div
        className="relative w-full min-h-[250px] sm:min-h-[350px] md:min-h-[475px] lg:min-h-[600px] xl:min-h-[700px]"
        style={{
      ...
      >
        ...
        {/* AboutUs Text */}
        <div className="container mx-auto px-4 absolute inset-0 flex items-center z-10">

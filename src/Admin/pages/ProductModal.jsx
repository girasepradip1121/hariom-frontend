...
const ProductModal = ({
  ...
  const handleSubmit = async (e) => {
    ...
    formPayload.append("actualPrice", formData.actualPrice);
    ...
    try {
      if (product) {
        await axios.put(`${USER_BASE_URL}/api/products/${product.id}`, formPayload, {
          headers: {
        ...
        const response = await axios.post(`${USER_BASE_URL}/api/products`, formPayload, {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              >
                ...
                {subCateData
                  ?.filter((item) => item?.cate_id === parseFloat(formData.categoryId))
                  ?.map((category) => (
                    <option key={category.sub_cate_id} value={category.sub_cate_id}>
          ...
          <div>
            ...
            {formData.howToUse.length === 0 && (
              <p className="text-sm text-gray-500">No how to use items added yet.</p>
            )}
            <div className="space-y-2 max-h-40 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Combos</label>
